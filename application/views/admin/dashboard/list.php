      ...
      <div class="row bg-white has-shadow">
        ...
        <div class="col-xl-3 col-sm-6">
          <div class="item d-flex align-items-center">
            ...
            <div class="number"><strong><?php echo $hitung_admin ?></strong></div>
          </div>
        </div>
        <!-- Item -->
        <div class="col-xl-3 col-sm-6">
          <div class="item d-flex align-items-center">
            ...
            <div class="title"><span>Paket<br>Tours</span>
              <div class="progress">
                <div role="progressbar" style="width: 70%; height: 4px;" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100" class="progress-bar bg-red"></div>
              </div>
            </div>
            <div class="number"><strong><?php echo $hitung_tours ?></strong></div>
          </div>
        </div>
        <!-- Item -->
        <div class="col-xl-3 col-sm-6">
          <div class="item d-flex align-items-center">
            ...
            <div class="title"><span>Pesan<br>diterima</span>
              <div class="progress">
