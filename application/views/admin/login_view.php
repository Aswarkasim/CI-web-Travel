...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/admin/https://fonts.googleapis.com/css?family=Poppins:300,400,700">
    <!-- theme stylesheet-->
              ...
              <div class="form d-flex align-items-center">
                <div class="content">
                  ...
                  <?php 
                      ...
                      echo validation_errors('<div class="alert alert-danger"><i class="fa da-warning"></i> ',' </div>');
